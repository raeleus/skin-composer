...
public class PopTextraTypist extends PopTable {
    ...
    private void showFileTable() {
        ...
        var textraButton = new TextraButton("[_]Quit to Skin Composer", skin, "tt-file-bar");
        textraButton.getTextraLabel().setAlignment(Align.left);
        table.add(textraButton);
        textraButton.addListener(handListener);
        onChange(textraButton, this::hide);
    
        table.row();
        var textButton = new TextButton("TextraTypist GitHub", skin, "tt-file-bar");
