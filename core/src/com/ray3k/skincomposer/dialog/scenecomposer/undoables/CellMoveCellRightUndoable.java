...
public class CellMoveCellRightUndoable implements SceneComposerUndoable {
    ...
    public CellMoveCellRightUndoable() {
    ...
    public String getRedoString() {
        return "Redo \"Move Cell Right\"";
    }
    
    @Override
    public String getUndoString() {
        return "Undo \"Move Cell Right\"";
    }
}
