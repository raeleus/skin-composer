...
public class ContainerSetWidgetUndoable implements SceneComposerUndoable {
    ...
    public ContainerSetWidgetUndoable(DialogSceneComposerEvents.WidgetType widgetType) {
        dialog = DialogSceneComposer.dialog;
        container = (DialogSceneComposerModel.SimContainer) dialog.simActor;
        
        previousWidget = container.child;
        ...
        newWidget.parent = container;
    }
    
    @Override
    public void undo() {
        container.child = previousWidget;
    ...
    public void redo() {
        ...
        if (dialog.simActor != container.child) {
            dialog.simActor = container.child;
            dialog.populateProperties();
        }
        dialog.populatePath();
        dialog.model.updatePreview();
    ...
    public String getRedoString() {
        return "Redo \"Set Widget for Container\"";
    }
    
    @Override
    public String getUndoString() {
        return "Undo \"Set Widget for Container\"";
    }
}
