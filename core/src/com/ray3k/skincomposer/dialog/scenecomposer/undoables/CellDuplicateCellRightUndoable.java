...
public class CellDuplicateCellRightUndoable implements SceneComposerUndoable {
    ...
    public CellDuplicateCellRightUndoable() {
    ...
    public String getRedoString() {
        return "Redo \"Duplicate Cell Right\"";
    }
    
    @Override
    public String getUndoString() {
        return "Undo \"Duplicate Cell Right\"";
    }
}
