...
public class CellMoveToNewRowBelowUndoable implements SceneComposerUndoable {
    private DialogSceneComposerModel.SimCell cell;
    private DialogSceneComposer dialog;
    private DialogSceneComposerModel.SimTable table;
    private int oldColumn;
    
    public CellMoveToNewRowBelowUndoable() {
    ...
    public String getRedoString() {
        return "Redo \"Move Cell to New Row Below\"";
    }
    
    @Override
    public String getUndoString() {
        return "Undo \"Move Cell to New Row Below\"";
    }
}
