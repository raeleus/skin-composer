...
public class ImageTextButtonPaddingUndoable implements SceneComposerUndoable {
    ...
    public ImageTextButtonPaddingUndoable(float padLeft, float padRight, float padTop, float padBottom) {
    ...
    public String getRedoString() {
        return "Redo \"ImageTextButton Padding\"";
    }
    
    @Override
    public String getUndoString() {
        return "Undo \"ImageTextButton Padding\"";
    }
}
